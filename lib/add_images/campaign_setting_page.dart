                ...
                children: [
                  ...
                  Chip(
                    ...
                    deleteIcon: Icon(Icons.cancel,
                        color: Colors.grey), // Optional: Customize delete icon
                    ...
                    decoration: InputDecoration(
                      ...
                      focusedBorder: OutlineInputBorder(
                        ...
                        borderSide: BorderSide(
                            color:
                                Colors.grey), // Set border color when focused
                      ),
                    ),
                    validator: (value) {
                  ...
                  Text('Ad Schedule',
                      style: TextStyle(fontSize: SC.from_height(17.5))),
                  Row(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Text(
                            'Age Range',
                            style: TextStyle(fontSize: SC.from_height(18)),
                          ),
                            ...
                            child: Column(
                              ...
                              children: PaymentMethod.values
                                  .map((e) => ListTile(
                                        ...
                                        title: Text(
                                            PaymentMethods.getPaymentName(e)),
                                        leading: Image.asset(
                                            PaymentMethods.getPaymentIcon(e),
                                            width: 50),
                                        onTap: () async {
