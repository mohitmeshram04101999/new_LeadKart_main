...
class TextStyles
{
  ...
  TextStyle leadTileTitle = TextStyle(fontSize: SC.from_width(17),fontWeight: FontWeight.w500,color: Color.fromRGBO(2, 2, 2, 1));
  TextStyle leadTileSubTitle = TextStyle(fontSize: SC.from_width(15),fontWeight: FontWeight.w400,color: Color.fromRGBO(98, 98, 98, 1));
