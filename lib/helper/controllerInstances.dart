...
class Controllers {
  ...
  static CreateBusinessProvider createBusinessProvider(BuildContext context,
          {bool listen = true}) =>
      Provider.of<CreateBusinessProvider>(context, listen: false);
  static BussnissCategoryProvider businessCategoryProvider(BuildContext context,
          {bool listen = true}) =>
      Provider.of<BussnissCategoryProvider>(context, listen: false);
  static Allplansprovider allPlansProvider(BuildContext context,
          {bool listen = true}) =>
      Provider.of<Allplansprovider>(context, listen: false);
  static Profileprovider profileProvider(BuildContext context,
          {bool listen = true}) =>
      Provider.of<Profileprovider>(context, listen: false);
  static EditBusinessProvider editBusinessProvider(BuildContext context,
          {bool listen = true}) =>
      Provider.of<EditBusinessProvider>(context, listen: false);
  static BusinessProvider businessProvider(BuildContext context,
          {bool listen = true}) =>
      Provider.of<BusinessProvider>(context, listen: false);
  static CreateAddProvider createAddProvider(BuildContext context,
          {bool listen = true}) =>
      Provider.of<CreateAddProvider>(context, listen: false);
  static CampaignProvider campaignProvider(BuildContext context,
          {bool listen = true}) =>
      Provider.of<CampaignProvider>(context, listen: false);
  static AddListByBusinessProvider addListByBusinessProvider(
          BuildContext context,
          {bool listen = true}) =>
      Provider.of<AddListByBusinessProvider>(context, listen: false);
  static LeadsProvider leadsProvider(BuildContext context,
          {bool listen = true}) =>
      Provider.of<LeadsProvider>(context, listen: false);
  static LeadDetailProvider leadDetailProvider(BuildContext context,
          {bool listen = true}) =>
      Provider.of<LeadDetailProvider>(context, listen: false);
  static SubUserProvider subUserProvider(BuildContext context,
          {bool listen = true}) =>
      Provider.of<SubUserProvider>(context, listen: false);
  static TargateAreaProvider targateAreaProvider(BuildContext context,
          {bool listen = true}) =>
      Provider.of<TargateAreaProvider>(context, listen: false);
  static RolesAndPermProvider rolesAndPermProvider(BuildContext context,
          {bool listen = true}) =>
      Provider.of<RolesAndPermProvider>(context, listen: false);
  static FaqProvider faqProvider(BuildContext context, {bool listen = true}) =>
