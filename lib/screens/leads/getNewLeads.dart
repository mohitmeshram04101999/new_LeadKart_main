                  ...
                  children: [
                    ...
                    Consumer<Allplansprovider>(
                      builder: (a,p,c){
                        ...
                        return  Column(
                          children: [
                             Text("OR",style: AppConstent.labelStyle(context),),
                            SizedBox(
                              height: SC.fromContextWidth(context, 20),
                            ),
                            Align(
                              ...
                              child: Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Text("Select a Plan",style: AppConstent.labelStyle(context),),
                              ),
                            ),
                          ],
                        );
                    ...
                    Align(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text("Package includes",style: AppConstent.labelStyle(context)),
                      ),
                    ),
                   ...
                   const  SizedBox(
                    ...
                    Align(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text("Package Frequently asked Questions",style: AppConstent.labelStyle(context),maxLines: 1,overflow: TextOverflow.ellipsis,),
                      ),
                    ),
                            ...
                            return  ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return Padding(
                                  ...
                                  child: ExpansionTile(
                                    backgroundColor: AppConstent().primeryColor.withOpacity(.2),
                                    childrenPadding: const EdgeInsets.only(left: 25,right: 20),
                                    title: Text(question.question??"",style: TextStyle(fontWeight: FontWeight.w500,fontSize: SC.from_width(16)),),
                                    children: [
